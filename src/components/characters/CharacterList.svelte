<script lang="ts">
    ...
    import { Bishop, Follower, Guard, Heretic, Machine, MiniBoss, Occultist, Player, Soldier, TOWW, Witness } from "../../scripts/characters";
...
<div class="flex flex-col gap-4">
    <div class="flex flex-col gap-4 items-center">
        ...
        <List class="no-scrollbar overflow-x-auto flex-row gap-4 p-2 w-90 sm:w-100" label="List of Characters" {enableKeyInput} isHorizontal isTabbable={false}>
            {#each [Follower, Player, Soldier, Occultist, Guard, Heretic, Machine, Bishop, TOWW, MiniBoss, Witness] as actor, i (i)} 
