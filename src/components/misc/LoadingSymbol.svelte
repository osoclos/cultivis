...
<div class="relative">
    <SpritesheetImage src="/static/assets/loading-symbols.png" label="Loading Symbol" x={Random.int(2)} y={0} tileWidth={1024} tileHeight={1024} width={512 - 128 * +isMobile} height={512 - 128 * +isMobile} />
